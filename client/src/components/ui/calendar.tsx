  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: "absolute left-1 border-none outline-none",
        nav_button_next: "absolute right-1 border-none outline-none",
        ...
        cell: cn(
          "relative p-0 w-[calc(100%/7)] text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day: cn(
          ...
          "size-8 p-0 font-normal aria-selected:opacity-100 rounded-3xl"
        ),
        day_range_start:
